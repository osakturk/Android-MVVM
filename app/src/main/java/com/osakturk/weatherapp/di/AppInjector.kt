...
//GitHubBrowserSample'daki bu yapıyı çok beğendiğim için onu kullandım.
// Beğenmemin sebebi ise; bu yapıyla Fragmentleri kolay bir şekilde injectable hale getirebiliyorum
object AppInjector {
